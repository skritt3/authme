  ...
  implements SettingsHolder
{
  ...
  @Comment({"Message language, available languages:", "https://github.com/AuthMe/AuthMeReloaded/blob/master/docs/translations.md"})
  ...
  @Comment({"By default we handle the AsyncPlayerPreLoginEvent which makes the plugin faster", "but it is incompatible with any permission plugin not included in our compatibility list.", "If you have issues with permission checks on player join please disable this option."})
  public static final Property<Boolean> USE_ASYNC_PRE_LOGIN_EVENT = PropertyInitializer.newProperty("settings.useAsyncPreLoginEvent", true);
}


/* Location:              C:\Users\Leonid\Downloads\AuthMe-5_4_0_jarSave.jar!\fr\xephi\authme\settings\properties\PluginSettings.class
